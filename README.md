...
Building a Technical Indicator library to run on CUDA cores for GPU-accelerated performance.
...
The home of the Centaur ecosystem — high-performance technical analysis tools for quantitative finance.

- [CRT - Technologies](https://tech.centaurresearchtechnologies.com/) — Learn how to use Centaur Technologies
...
- [API Reference](https://docs.rs/centaur_technical_indicators/latest/centaur_technical_indicators/) · [Tutorials](https://github.com/chironmind/CentaurTechnicalIndicators-Rust-Tutorials) · [How-To Guides](https://github.com/chironmind/CentaurTechnicalIndicators-Rust-How-to-Guides) · [Benchmarks](https://github.com/chironmind/CentaurTechnicalIndicators-Rust-Benchmarks)
...
- [API Reference](https://centaurtechnicalindicators-python.readthedocs.io/en/latest/api/) · [Tutorials](https://centaurtechnicalindicators-python.readthedocs.io/en/latest/tutorials/) · [How-To Guides](https://centaurtechnicalindicators-python.readthedocs.io/en/latest/howto/) · [Benchmarks](https://centaurtechnicalindicators-python.readthedocs.io/en/latest/benchmarks/)
...
- [API Reference](https://chironmind.github.io/CentaurTechnicalIndicators-JS/api/) · [Tutorials](https://chironmind.github.io/CentaurTechnicalIndicators-JS/tutorials/) · [How-To Guides](https://chironmind.github.io/CentaurTechnicalIndicators-JS/howto/)
